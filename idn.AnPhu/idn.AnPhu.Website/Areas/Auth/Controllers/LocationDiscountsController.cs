...
namespace idn.AnPhu.Website.Areas.Auth.Controllers
{
    public class LocationDiscountsController : AdministratorController
    {
        ...
        #region["List danh mục chiết khấu theo vùng miền"]
        ...
        {
            ViewBag.Title = "Tạo mới danh mục chiết khấu theo vùng miền";
            ViewBag.message = "";
            return View();
        }
        ...
        #region["Xóa chiết khấu theo vùng miền"]
        [HttpGet]
        public ActionResult Delete(int LocationDiscountId)
        {
            ...
            try
            {
                ...
                //ViewBag.message = "Xóa chiết khấu theo vùng miền mã " + LocationDiscountsId + "thành công";
