...
function banner(imgView){
	...
	if(imgTotal<=4) {
		document.getElementById("arr_right").getElementsByTagName("a")[0].removeAttribute("href");
		document.getElementById("arr_right").getElementsByTagName("img")[0].src="/worldwide/images/experience/arr_right_off.gif";
	}
	...
	btn_prev_a.onclick = function(){
		...
		if( (click_num >= imgTotal/imgView)  && btn_next_img.src.indexOf("_on") >= 0 ){
			btn_next_img.src = btn_next_img.src.replace("_on.gif", "_off.gif");
		}else if ((click_num < imgTotal/imgView)  && btn_next_img.src.indexOf("_on") < 0){
			btn_next_img.src = btn_next_img.src.replace("_off.gif", "_on.gif");
		}

		if(click_num >= 1 && btn_prev_img.src.indexOf("_on") < 1){
			btn_prev_img.src =btn_prev_img.src.replace("_off.gif", "_on.gif");
		}else if (click_num == 1 && btn_prev_img.src.indexOf("_on") >= 1){
			btn_prev_img.src =btn_prev_img.src.replace("_on.gif", "_off.gif");
		}
		...
		function change_button(num,obj) {
			if (num>0 && num<=pages.length) {
				...
				if (isCube==1) {
					...
					*/
					if (num==1) $("div.prevbtn a img").attr("src","./wcm/images/main/blank.gif");
					else $("div.prevbtn a img").attr("src","./wcm/images/main/btn_cube_left.png");
					if (num==pages.length) $("div.nextbtn a img").attr("src","./wcm/images/main/blank.gif");
					else $("div.nextbtn a img").attr("src","./wcm/images/main/btn_cube_right.png");
	...
	function cubeStart(va) {
		...
		if (va==1) { // main
			...
			$(".cubebox .cubelist .items a img.movie").click(function() {
				...
				// 10)	Like 버튼 URL
				// 11)	main (????)
				showGalleryLargeLayer("http://www.youtube.com/embed/vtb2XLpAMBw?rel=0","azera","/es/img_tmp/txt_azera_layer.png","High Glass Sun Roof","movie","downloadurl","twitter link","facebook link","stumbleupon link","http://test.com","main");
			});
			...
			for (var i=1; i<=20; i++) { // 목록 20??출력
				...
				// ??�??경우
				cubeGalleryList("interior","/es/img_tmp/cube_gallery_small_"+t+".jpg","/es/img_tmp/gallery_popup.jpg","azera","/es/img_tmp/txt_azera_layer.png","High Glass Sun Roof","image","downloadurl","twitter link","facebook link","stumbleupon link",'http://test.com');
			...
			cubeExperience("exterior","./wcm/images/exterior/HG_small/HG_S_0.PNG","./wcm/images/exterior/HG_small/HG_S_0.PNG","");
			...
			// 6) ??�????�?
			// 7) ??�????�?
			cubeMostLikeCate(1,'/es/img_tmp/profile30.jpg','/es/img_tmp/profile30.jpg','/es/img_tmp/profile30.jpg','Jeff','Antonio','Jane');
			...
			// 7) Car Builder 링크
			// 8) Link버튼 코드
			cubeMostLike('AZERA','1.6 CRDi GLS FDU','/es/img_tmp/color_1.png','/es/img_tmp/color_interior_1.png','/es/img_tmp/car_mostlike.png','#','#','<a href="#"><img src="/es/img_tmp/like.gif" alt="" /></a>');
			...
			// 3) ??�????????			// 4) ??�?
			// 5) ????
			cubeTalknTalk(1,'facebook','/es/img_tmp/profile25.jpg','Dabby whistler','I can\'t belive my eyes. AZERA is so nice');
			cubeTalknTalk(2,'twitter','/es/img_tmp/profile25.jpg','Dabby whistler','I can\'t belive my eyes. AZERA is so nice');
			cubeTalknTalk(3,'facebook','/es/img_tmp/profile25.jpg','Dabby whistler','AZERA has a good performance to drive. It\'s really interesting for me');
			cubeTalknTalk(4,'twitter','/es/img_tmp/profile25.jpg','Dabby whistler','I can\'t belive my eyes. AZERA is so nice');
			cubeTalknTalk(5,'facebook','/es/img_tmp/profile25.jpg','Dabby whistler','AZERA has a good performance to drive. It\'s really interesting for me');
			cubeTalknTalk(6,'facebook','/es/img_tmp/profile25.jpg','Dabby whistler','I can\'t belive my eyes. AZERA is so nice');
	...
	return this.each(function() {
		...
		function makeHTML(cate, targetObj) {
			...
			if(type=="movie") {
				...
				$(".jgallery_wrap .jgallery",targetObj).append('<div class="photo"><div class="photo_view"></div><div class="function"><div class="share"><span>Share</span> <div class="sns_share"><a href="#" class="facebook"><img src="/worldwide/images/experience/sponsorship/new_sponsorships/icon_social_facebook.png" alt=""></a> <a href="#" class="twitter"><img src="/worldwide/images/experience/sponsorship/new_sponsorships/icon_social_twitter.png" alt=""></a>  <a href="#" class="pinterest"><img src="/worldwide/images/experience/sponsorship/new_sponsorships/icon_social_pinterest.png" alt=""></a></div><div class="facebook_like"></div></div><a class="viewmore" href="#"><img alt="" src="/worldwide/images/experience/sponsorship/new_sponsorships/icon_viewmore.png"></a></div><div class="description"><strong></strong><span></span></div><div class="direction_nav"><div class="prev"><a href="#">Prev</a></div><div class="next"><a href="#">Next</a></div></div></div>');
			...
			$(".jgallery_wrap .jgallery .roll ul li a", targetObj).click(function() {
				...
				if(type=="movie") {
					$(".photo .movie_view", targetObj).html('<iframe src="//www.youtube.com/embed/'+$(this).attr("href").split("/embed/")[1]+'?wmode=opaque" width="669" height="492" border="0"></iframe>');
				} else {
				...
				if($(this).find("img").attr("alt")=="" || $(this).find("img").attr("alt") == " ") {
					...
					if($(this).attr("href").indexOf("/embed/") != -1) {
						$(".description", targetObj).hide();
					} else {
			...
			$(".function a.viewmore",targetObj).click(function() {
				...
				$("#sponsorship_layer_gallery").append('<div class="layer_gallery_close"><a href="#"><img alt="close" src="/worldwide/images/experience/sponsorship/new_sponsorships/btn_layer_close2.png"></a></div>');
